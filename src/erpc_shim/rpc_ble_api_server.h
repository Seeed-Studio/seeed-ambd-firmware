/*
 * Generated by erpcgen 1.7.4 on Wed Aug 12 15:45:06 2020.
 *
...
private:
    ...
    /*! @brief Server shim for rpc_le_get_param of rpc_gap_le interface. */
    erpc_status_t rpc_le_get_param_shim(erpc::Codec * codec, erpc::MessageBufferFactory *messageFactory, uint32_t sequence);
