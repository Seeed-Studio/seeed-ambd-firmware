...
private:
    ...
    /*! @brief Server shim for rpc_le_scan_start2 of rpc_gap_scan interface. */
    erpc_status_t rpc_le_scan_start2_shim(erpc::Codec * codec, erpc::MessageBufferFactory *messageFactory, uint32_t sequence);
