/*
 * Generated by erpcgen 1.7.4 on Fri Oct  9 17:48:46 2020.
 *
...
int32_t rpc_tcpip_adapter_get_ip_info(uint32_t tcpip_if, const binary_t * ip_info);
...
int32_t rpc_tcpip_adapter_get_dns_info(uint32_t tcpip_if, uint32_t dns_type, const binary_t * dns);
