...
{
    krpc_wifi_mbedtls_service_id = 16,
    ...
    krpc_wifi_mbedtls_rpc_wifi_start_ssl_client_id = 8,
    krpc_wifi_mbedtls_rpc_wifi_stop_ssl_socket_id = 9,
    krpc_wifi_mbedtls_rpc_wifi_data_to_read_id = 10,
    krpc_wifi_mbedtls_rpc_wifi_send_ssl_data_id = 11,
    krpc_wifi_mbedtls_rpc_wifi_get_ssl_receive_id = 12,
    krpc_wifi_mbedtls_rpc_wifi_verify_ssl_fingerprint_id = 13,
    krpc_wifi_mbedtls_rpc_wifi_verify_ssl_dn_id = 14,
    krpc_wifi_mbedtls_rpc_wifi_ssl_strerror_id = 15,
};
