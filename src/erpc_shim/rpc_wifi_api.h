...
enum _rpc_wifi_tcpip_ids
{
    ...
    krpc_wifi_tcpip_rpc_ip4addr_ntoa_id = 1,
    krpc_wifi_tcpip_rpc_inet_chksum_id = 2,
    krpc_wifi_tcpip_rpc_tcpip_adapter_init_id = 3,
    krpc_wifi_tcpip_rpc_tcpip_adapter_sta_start_id = 4,
    krpc_wifi_tcpip_rpc_tcpip_adapter_ap_start_id = 5,
    krpc_wifi_tcpip_rpc_tcpip_adapter_stop_id = 6,
    krpc_wifi_tcpip_rpc_tcpip_adapter_up_id = 7,
    krpc_wifi_tcpip_rpc_tcpip_adapter_down_id = 8,
    krpc_wifi_tcpip_rpc_tcpip_adapter_get_ip_info_id = 9,
    krpc_wifi_tcpip_rpc_tcpip_adapter_set_ip_info_id = 10,
    krpc_wifi_tcpip_rpc_tcpip_adapter_set_dns_info_id = 11,
    krpc_wifi_tcpip_rpc_tcpip_adapter_get_dns_info_id = 12,
    krpc_wifi_tcpip_rpc_tcpip_adapter_dhcps_start_id = 13,
    krpc_wifi_tcpip_rpc_tcpip_adapter_dhcps_stop_id = 14,
    krpc_wifi_tcpip_rpc_tcpip_adapter_dhcpc_start_id = 15,
    krpc_wifi_tcpip_rpc_tcpip_adapter_dhcpc_stop_id = 16,
    krpc_wifi_tcpip_rpc_tcpip_adapter_set_hostname_id = 17,
    krpc_wifi_tcpip_rpc_tcpip_adapter_get_hostname_id = 18,
    krpc_wifi_tcpip_rpc_tcpip_adapter_get_mac_id = 19,
    krpc_wifi_tcpip_rpc_tcpip_adapter_set_mac_id = 20,
    krpc_wifi_tcpip_rpc_tcpip_api_call_id = 21,
    krpc_wifi_tcpip_rpc_tcp_connect_id = 22,
    krpc_wifi_tcpip_rpc_tcp_recved_id = 23,
    krpc_wifi_tcpip_rpc_tcp_abort_id = 24,
    krpc_wifi_tcpip_rpc_tcp_write_id = 25,
    krpc_wifi_tcpip_rpc_tcp_output_id = 26,
    krpc_wifi_tcpip_rpc_tcp_close_id = 27,
    krpc_wifi_tcpip_rpc_tcp_bind_id = 28,
    krpc_wifi_tcpip_rpc_tcp_new_ip_type_id = 29,
    krpc_wifi_tcpip_rpc_tcp_arg_id = 30,
    krpc_wifi_tcpip_rpc_tcp_err_id = 31,
    krpc_wifi_tcpip_rpc_tcp_recv_id = 32,
    krpc_wifi_tcpip_rpc_tcp_sent_id = 33,
    krpc_wifi_tcpip_rpc_tcp_accept_id = 34,
    krpc_wifi_tcpip_rpc_tcp_poll_id = 35,
    krpc_wifi_tcpip_rpc_tcp_listen_with_backlog_id = 36,
    krpc_wifi_tcpip_rpc_pbuf_free_id = 37,
};
...
/*! @brief rpc_wifi_ip4_addr identifiers */
enum _rpc_wifi_ip4_addr_ids
{
    krpc_wifi_ip4_addr_service_id = 20,
};

/*! @brief rpc_wifi_inet_chksum identifiers */
enum _rpc_wifi_inet_chksum_ids
{
    krpc_wifi_inet_chksum_service_id = 21,
};
