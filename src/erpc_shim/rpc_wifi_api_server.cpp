...
static ManuallyConstructed<rpc_wifi_ip4_addr_service> s_rpc_wifi_ip4_addr_service;

static ManuallyConstructed<rpc_wifi_inet_chksum_service> s_rpc_wifi_inet_chksum_service;
...
// Call the correct server shim based on method unique ID.
erpc_status_t rpc_wifi_ip4_addr_service::handleInvocation(uint32_t methodId, uint32_t sequence, Codec * codec, MessageBufferFactory *messageFactory)
{
    switch (methodId)
    {
        default:
...
// Call the correct server shim based on method unique ID.
erpc_status_t rpc_wifi_inet_chksum_service::handleInvocation(uint32_t methodId, uint32_t sequence, Codec * codec, MessageBufferFactory *messageFactory)
{
    switch (methodId)
    {
        default:
...
erpc_service_t create_rpc_wifi_ip4_addr_service()
{
    s_rpc_wifi_ip4_addr_service.construct();
    return s_rpc_wifi_ip4_addr_service.get();
}

void destroy_rpc_wifi_ip4_addr_service()
{
    s_rpc_wifi_ip4_addr_service.destroy();
}

erpc_service_t create_rpc_wifi_inet_chksum_service()
{
    s_rpc_wifi_inet_chksum_service.construct();
    return s_rpc_wifi_inet_chksum_service.get();
}

void destroy_rpc_wifi_inet_chksum_service()
{
    s_rpc_wifi_inet_chksum_service.destroy();
}
