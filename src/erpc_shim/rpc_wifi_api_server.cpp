...
erpc_status_t rpc_wifi_drv_service::handleInvocation(uint32_t methodId, uint32_t sequence, Codec * codec, MessageBufferFactory *messageFactory)
{
    switch (methodId)
    {
        ...
        case krpc_wifi_drv_rpc_wifi_get_txpower_id:
            return rpc_wifi_get_txpower_shim(codec, messageFactory, sequence);

        case krpc_wifi_drv_rpc_wifi_set_txpower_id:
            return rpc_wifi_set_txpower_shim(codec, messageFactory, sequence);
        ...
        case krpc_wifi_drv_rpc_wifi_set_ap_polling_sta_id:
            return rpc_wifi_set_ap_polling_sta_shim(codec, messageFactory, sequence);
...
#endif
        result = rpc_wifi_connect(ssid, password, ecurity_type, key_id, semaphore);
#if ERPC_NESTED_CALLS_DETECTION
...
erpc_status_t rpc_wifi_drv_service::rpc_wifi_connect_bssid_shim(Codec * codec, MessageBufferFactory *messageFactory, uint32_t sequence)
{
    ...
    if (!err)
    {
        ...
        nestingDetection = true;
#endif
        result = rpc_wifi_connect_bssid(bssid, ssid, password, ecurity_type, key_id, semaphore);
#if ERPC_NESTED_CALLS_DETECTION
        nestingDetection = false;
#endif
...
// Server shim for rpc_wifi_get_txpower of rpc_wifi_drv interface.
erpc_status_t rpc_wifi_drv_service::rpc_wifi_get_txpower_shim(Codec * codec, MessageBufferFactory *messageFactory, uint32_t sequence)
{
    erpc_status_t err = kErpcStatus_Success;
    ...
    if (!err)
    {
        ...
        nestingDetection = true;
#endif
        result = rpc_wifi_get_txpower(&poweridx);
#if ERPC_NESTED_CALLS_DETECTION
        nestingDetection = false;
#endif
    ...
    if (!err)
    {
        ...
        // Build response message.
        codec->startWriteMessage(kReplyMessage, krpc_wifi_drv_service_id, krpc_wifi_drv_rpc_wifi_get_txpower_id, sequence);

        codec->write(poweridx);
...
// Server shim for rpc_wifi_set_txpower of rpc_wifi_drv interface.
erpc_status_t rpc_wifi_drv_service::rpc_wifi_set_txpower_shim(Codec * codec, MessageBufferFactory *messageFactory, uint32_t sequence)
{
    erpc_status_t err = kErpcStatus_Success;
    ...
    if (!err)
    {
        ...
        nestingDetection = true;
#endif
        result = rpc_wifi_set_txpower(poweridx);
#if ERPC_NESTED_CALLS_DETECTION
        nestingDetection = false;
#endif
    ...
    if (!err)
    {
        ...
        // Build response message.
        codec->startWriteMessage(kReplyMessage, krpc_wifi_drv_service_id, krpc_wifi_drv_rpc_wifi_set_txpower_id, sequence);
...
erpc_status_t rpc_wifi_drv_service::rpc_wifi_start_ap_shim(Codec * codec, MessageBufferFactory *messageFactory, uint32_t sequence)
{
    ...
    if (!err)
    {
        ...
        nestingDetection = true;
#endif
        result = rpc_wifi_start_ap(ssid, password, ecurity_type, channel);
#if ERPC_NESTED_CALLS_DETECTION
        nestingDetection = false;
#endif
...
erpc_status_t rpc_wifi_drv_service::rpc_wifi_start_ap_with_hidden_ssid_shim(Codec * codec, MessageBufferFactory *messageFactory, uint32_t sequence)
{
    ...
    if (!err)
    {
        ...
        nestingDetection = true;
#endif
        result = rpc_wifi_start_ap_with_hidden_ssid(ssid, password, ecurity_type, channel);
#if ERPC_NESTED_CALLS_DETECTION
        nestingDetection = false;
#endif
...
erpc_status_t rpc_wifi_drv_service::rpc_wifi_restart_ap_shim(Codec * codec, MessageBufferFactory *messageFactory, uint32_t sequence)
{
    ...
    if (!err)
    {
        ...
        nestingDetection = true;
#endif
        result = rpc_wifi_restart_ap(ssid, password, ecurity_type, channel);
#if ERPC_NESTED_CALLS_DETECTION
        nestingDetection = false;
#endif
...
// Server shim for rpc_wifi_set_ap_polling_sta of rpc_wifi_drv interface.
erpc_status_t rpc_wifi_drv_service::rpc_wifi_set_ap_polling_sta_shim(Codec * codec, MessageBufferFactory *messageFactory, uint32_t sequence)
{
    erpc_status_t err = kErpcStatus_Success;
    ...
    if (!err)
    {
        ...
        nestingDetection = true;
#endif
        rpc_wifi_set_ap_polling_sta(enabled);
#if ERPC_NESTED_CALLS_DETECTION
        nestingDetection = false;
#endif
    ...
    if (!err)
    {
        ...
        // Build response message.
        codec->startWriteMessage(kReplyMessage, krpc_wifi_drv_service_id, krpc_wifi_drv_rpc_wifi_set_ap_polling_sta_id, sequence);
