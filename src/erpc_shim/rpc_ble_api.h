/*
 * Generated by erpcgen 1.7.4 on Fri Aug 21 13:56:27 2020.
 *
...
{
    khost_service_id = 1,
    khost_rpc_ble_init_id = 1,
    khost_rpc_ble_start_id = 2,
    khost_rpc_ble_deinit_id = 3,
};
...
enum _rpc_gap_scan_ids
{
    ...
    krpc_gap_scan_rpc_le_scan_info_filter_id = 5,
};
...
{
    krpc_gatt_client_service_id = 9,
    krpc_gatt_client_rpc_client_init_id = 1,
    krpc_gatt_client_rpc_client_all_primary_srv_discovery_id = 2,
    krpc_gatt_client_rpc_client_by_uuid_srv_discovery_id = 3,
    krpc_gatt_client_rpc_client_by_uuid128_srv_discovery_id = 4,
    krpc_gatt_client_rpc_client_relationship_discovery_id = 5,
    krpc_gatt_client_rpc_client_all_char_discovery_id = 6,
    krpc_gatt_client_rpc_client_by_uuid_char_discovery_id = 7,
    krpc_gatt_client_rpc_client_by_uuid128_char_discovery_id = 8,
    krpc_gatt_client_rpc_client_all_char_descriptor_discovery_id = 9,
    krpc_gatt_client_rpc_client_attr_read_id = 10,
    krpc_gatt_client_rpc_client_attr_read_using_uuid_id = 11,
    krpc_gatt_client_rpc_client_attr_write_id = 12,
    krpc_gatt_client_rpc_client_attr_ind_confirm_id = 13,
};
