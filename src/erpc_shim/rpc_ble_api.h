...
{
    krpc_gatt_server_service_id = 10,
    ...
    krpc_gatt_server_rpc_server_exec_write_confirm_id = 9,
    krpc_gatt_server_rpc_server_attr_write_confirm_id = 10,
    krpc_gatt_server_rpc_server_attr_read_confirm_id = 11,
};
