...
// rpc_wifi_drv interface rpc_wifi_get_txpower function client shim.
int32_t rpc_wifi_get_txpower(int32_t * poweridx)
{
    ...
    {
        codec->startWriteMessage(kInvocationMessage, krpc_wifi_drv_service_id, krpc_wifi_drv_rpc_wifi_get_txpower_id, request.getSequence());
    ...
    // Invoke error handler callback function
    g_client->callErrorHandler(err, krpc_wifi_drv_rpc_wifi_get_txpower_id);
...
// rpc_wifi_drv interface rpc_wifi_set_txpower function client shim.
int32_t rpc_wifi_set_txpower(int32_t poweridx)
{
    ...
    {
        codec->startWriteMessage(kInvocationMessage, krpc_wifi_drv_service_id, krpc_wifi_drv_rpc_wifi_set_txpower_id, request.getSequence());
    ...
    // Invoke error handler callback function
    g_client->callErrorHandler(err, krpc_wifi_drv_rpc_wifi_set_txpower_id);
...
// rpc_wifi_drv interface rpc_wifi_set_ap_polling_sta function client shim.
void rpc_wifi_set_ap_polling_sta(uint8_t enabled)
{
    ...
    {
        codec->startWriteMessage(kInvocationMessage, krpc_wifi_drv_service_id, krpc_wifi_drv_rpc_wifi_set_ap_polling_sta_id, request.getSequence());
    ...
    // Invoke error handler callback function
    g_client->callErrorHandler(err, krpc_wifi_drv_rpc_wifi_set_ap_polling_sta_id);
