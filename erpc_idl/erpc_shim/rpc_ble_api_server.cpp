/*
 * Generated by erpcgen 1.7.4 on Thu Sep 10 16:21:06 2020.
 *
...
// Server shim for rpc_ble_init of host interface.
erpc_status_t host_service::rpc_ble_init_shim(Codec * codec, MessageBufferFactory *messageFactory, uint32_t sequence)
{
    ...
    if (!err)
    {
        ...
        codec->startWriteMessage(kReplyMessage, khost_service_id, khost_rpc_ble_init_id, sequence);
...
// Server shim for rpc_ble_start of host interface.
erpc_status_t host_service::rpc_ble_start_shim(Codec * codec, MessageBufferFactory *messageFactory, uint32_t sequence)
{
    erpc_status_t err = kErpcStatus_Success;
    ...
    if (!err)
    {
        ...
        // Build response message.
        codec->startWriteMessage(kReplyMessage, khost_service_id, khost_rpc_ble_start_id, sequence);
...
// Server shim for rpc_ble_deinit of host interface.
erpc_status_t host_service::rpc_ble_deinit_shim(Codec * codec, MessageBufferFactory *messageFactory, uint32_t sequence)
{
    erpc_status_t err = kErpcStatus_Success;
    ...
    if (!err)
    {
        ...
        // Build response message.
        codec->startWriteMessage(kReplyMessage, khost_service_id, khost_rpc_ble_deinit_id, sequence);
...
erpc_status_t rpc_gap_scan_service::handleInvocation(uint32_t methodId, uint32_t sequence, Codec * codec, MessageBufferFactory *messageFactory)
{
    switch (methodId)
    {
        ...
        case krpc_gap_scan_rpc_le_scan_start2_id:
            return rpc_le_scan_start2_shim(codec, messageFactory, sequence);
...
// Server shim for rpc_le_scan_start2 of rpc_gap_scan interface.
erpc_status_t rpc_gap_scan_service::rpc_le_scan_start2_shim(Codec * codec, MessageBufferFactory *messageFactory, uint32_t sequence)
{
    erpc_status_t err = kErpcStatus_Success;
    ...
    if (!err)
    {
        ...
        nestingDetection = true;
#endif
        result = rpc_le_scan_start2(tick);
#if ERPC_NESTED_CALLS_DETECTION
        nestingDetection = false;
#endif
    ...
    if (!err)
    {
        ...
        // Build response message.
        codec->startWriteMessage(kReplyMessage, krpc_gap_scan_service_id, krpc_gap_scan_rpc_le_scan_start2_id, sequence);
