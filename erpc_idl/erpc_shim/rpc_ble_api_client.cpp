...
// rpc_gap_scan interface rpc_le_scan_start2 function client shim.
RPC_T_GAP_CAUSE rpc_le_scan_start2(uint32_t tick)
{
    ...
    {
        codec->startWriteMessage(kInvocationMessage, krpc_gap_scan_service_id, krpc_gap_scan_rpc_le_scan_start2_id, request.getSequence());
    ...
    // Invoke error handler callback function
    g_client->callErrorHandler(err, krpc_gap_scan_rpc_le_scan_start2_id);
