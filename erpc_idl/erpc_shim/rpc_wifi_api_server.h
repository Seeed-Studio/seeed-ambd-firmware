...
/*!
 * @brief Service subclass for rpc_wifi_ip4_addr.
 */
class rpc_wifi_ip4_addr_service : public erpc::Service
{
public:
    rpc_wifi_ip4_addr_service() : Service(krpc_wifi_ip4_addr_service_id) {}
...
/*!
 * @brief Service subclass for rpc_wifi_inet_chksum.
 */
class rpc_wifi_inet_chksum_service : public erpc::Service
{
public:
    rpc_wifi_inet_chksum_service() : Service(krpc_wifi_inet_chksum_service_id) {}
...
erpc_service_t create_rpc_wifi_ip4_addr_service(void);

void destroy_rpc_wifi_ip4_addr_service(void);

erpc_service_t create_rpc_wifi_inet_chksum_service(void);

void destroy_rpc_wifi_inet_chksum_service(void);
