...
enum _rpc_wifi_drv_ids
{
    ...
    krpc_wifi_drv_rpc_wifi_get_txpower_id = 14,
    krpc_wifi_drv_rpc_wifi_set_txpower_id = 15,
    krpc_wifi_drv_rpc_wifi_get_associated_client_list_id = 16,
    krpc_wifi_drv_rpc_wifi_get_ap_bssid_id = 17,
    krpc_wifi_drv_rpc_wifi_get_ap_info_id = 18,
    krpc_wifi_drv_rpc_wifi_set_country_id = 19,
    krpc_wifi_drv_rpc_wifi_get_sta_max_data_rate_id = 20,
    krpc_wifi_drv_rpc_wifi_get_rssi_id = 21,
    krpc_wifi_drv_rpc_wifi_set_channel_id = 22,
    krpc_wifi_drv_rpc_wifi_get_channel_id = 23,
    krpc_wifi_drv_rpc_wifi_change_channel_plan_id = 24,
    krpc_wifi_drv_rpc_wifi_register_multicast_address_id = 25,
    krpc_wifi_drv_rpc_wifi_unregister_multicast_address_id = 26,
    krpc_wifi_drv_rpc_wifi_rf_on_id = 27,
    krpc_wifi_drv_rpc_wifi_rf_off_id = 28,
    krpc_wifi_drv_rpc_wifi_on_id = 29,
    krpc_wifi_drv_rpc_wifi_off_id = 30,
    krpc_wifi_drv_rpc_wifi_set_mode_id = 31,
    krpc_wifi_drv_rpc_wifi_off_fastly_id = 32,
    krpc_wifi_drv_rpc_wifi_set_power_mode_id = 33,
    krpc_wifi_drv_rpc_wifi_set_tdma_param_id = 34,
    krpc_wifi_drv_rpc_wifi_set_lps_dtim_id = 35,
    krpc_wifi_drv_rpc_wifi_get_lps_dtim_id = 36,
    krpc_wifi_drv_rpc_wifi_set_lps_thresh_id = 37,
    krpc_wifi_drv_rpc_wifi_set_lps_level_id = 38,
    krpc_wifi_drv_rpc_wifi_set_mfp_support_id = 39,
    krpc_wifi_drv_rpc_wifi_start_ap_id = 40,
    krpc_wifi_drv_rpc_wifi_start_ap_with_hidden_ssid_id = 41,
    krpc_wifi_drv_rpc_wifi_set_pscan_chan_id = 42,
    krpc_wifi_drv_rpc_wifi_get_setting_id = 43,
    krpc_wifi_drv_rpc_wifi_set_network_mode_id = 44,
    krpc_wifi_drv_rpc_wifi_get_network_mode_id = 45,
    krpc_wifi_drv_rpc_wifi_set_wps_phase_id = 46,
    krpc_wifi_drv_rpc_wifi_restart_ap_id = 47,
    krpc_wifi_drv_rpc_wifi_config_autoreconnect_id = 48,
    krpc_wifi_drv_rpc_wifi_set_autoreconnect_id = 49,
    krpc_wifi_drv_rpc_wifi_get_autoreconnect_id = 50,
    krpc_wifi_drv_rpc_wifi_get_last_error_id = 51,
    krpc_wifi_drv_rpc_wifi_add_custom_ie_id = 52,
    krpc_wifi_drv_rpc_wifi_update_custom_ie_id = 53,
    krpc_wifi_drv_rpc_wifi_del_custom_ie_id = 54,
    krpc_wifi_drv_rpc_wifi_set_indicate_mgnt_id = 55,
    krpc_wifi_drv_rpc_wifi_get_drv_ability_id = 56,
    krpc_wifi_drv_rpc_wifi_set_channel_plan_id = 57,
    krpc_wifi_drv_rpc_wifi_get_channel_plan_id = 58,
    krpc_wifi_drv_rpc_wifi_enable_forwarding_id = 59,
    krpc_wifi_drv_rpc_wifi_disable_forwarding_id = 60,
    krpc_wifi_drv_rpc_wifi_set_ch_deauth_id = 61,
    krpc_wifi_drv_rpc_wifi_set_ap_polling_sta_id = 62,
    krpc_wifi_drv_rpc_wifi_get_band_type_id = 63,
    krpc_wifi_drv_rpc_wifi_set_tx_pause_data_id = 64,
};
